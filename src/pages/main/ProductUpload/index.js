                ...
                <Col xl={12}>
                    <div className="mc-card">
                        ...
                        <div className="mc-product-upload-media">
                            <div className="mc-product-upload-image"><img src="images/product01.png" alt="product" /></div>
                            <div className="mc-product-upload-image"><img src="images/product02.png" alt="product" /></div>
                            <div className="mc-product-upload-image"><img src="images/product03.png" alt="product" /></div>
                            <div className="mc-product-upload-image"><img src="images/product04.png" alt="product" /></div>
